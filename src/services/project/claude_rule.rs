...
impl ClaudeRuleService {
    ...
    pub async fn manage_rule_file(
        ...
        println!("✓ Claude Code 规则文件已生成: {}", rule_file_path);
    ...
    fn get_advanced_template(&self) -> String {
        include_str!("../../../assets/templates/claude_rule/advanced.md").to_string()
    }

    /// 获取基础模板内容
    fn get_basic_template(&self) -> String {
        include_str!("../../../assets/templates/claude_rule/basic.md").to_string()
    }
...
impl Default for ClaudeRuleService {
    fn default() -> Self {
        Self::new()
    }
}
...
/// 公共接口函数，供 CLI 层调用
pub async fn manage_claude_rule_file(template_type: &str, force: bool) -> Result<(), ScxVoidError> {
    let service = ClaudeRuleService::new();
